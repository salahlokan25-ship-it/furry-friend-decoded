...
const TrainingPage = () => {
  ...
  // Additional Dog Courses (20-50)
  {
    id: "dog-water-safety",
    title: "Water Safety & Swimming",
    description: "Teaching dogs to swim safely and enjoy water activities",
    petType: "dog",
    progress: 0,
    duration: "4 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "intro-water", title: "Water Introduction", content: "Gradually introduce water play", duration: "25 min", completed: false}],
  },
  {
    id: "dog-car-training",
    title: "Car Travel Training",
    description: "Making car rides stress-free and enjoyable",
    petType: "dog",
    progress: 0,
    duration: "3 weeks",
    difficulty: "Beginner",
    lessons: [{id: "car-intro", title: "Car Introduction", content: "Build positive car associations", duration: "20 min", completed: false}],
  },
  {
    id: "dog-urban-living",
    title: "City Dog Training",
    description: "Essential skills for dogs in urban environments",
    petType: "dog",
    progress: 0,
    duration: "5 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "city-manners", title: "Urban Manners", content: "Navigate busy city streets", duration: "30 min", completed: false}],
  },
  {
    id: "dog-service-basics",
    title: "Service Dog Foundations",
    description: "Basic service dog task training",
    petType: "dog",
    progress: 0,
    duration: "12 weeks",
    difficulty: "Advanced",
    lessons: [{id: "task-training", title: "Task Training Basics", content: "Learn basic service tasks", duration: "45 min", completed: false}],
  },
  {
    id: "dog-herding-intro",
    title: "Herding Instinct Training",
    description: "Channel natural herding instincts productively",
    petType: "dog",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Advanced",
    lessons: [{id: "herding-basics", title: "Herding Fundamentals", content: "Control herding behaviors", duration: "40 min", completed: false}],
  },
  {
    id: "dog-tricks-advanced",
    title: "Advanced Trick Training",
    description: "Impressive tricks and complex behaviors",
    petType: "dog",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Advanced",
    lessons: [{id: "complex-tricks", title: "Complex Trick Sequences", content: "Multi-step trick training", duration: "35 min", completed: false}],
  },
  {
    id: "dog-scent-work",
    title: "Scent Detection Sports",
    description: "Competitive scent work and nose games",
    petType: "dog",
    progress: 0,
    duration: "10 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "scent-intro", title: "Scent Work Introduction", content: "Basic scent detection", duration: "30 min", completed: false}],
  },
  {
    id: "dog-dock-diving",
    title: "Dock Diving Training",
    description: "Competitive dock diving and distance jumping",
    petType: "dog",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Advanced",
    lessons: [{id: "dock-basics", title: "Dock Diving Basics", content: "Learn to dock dive", duration: "35 min", completed: false}],
  },
  {
    id: "dog-flyball",
    title: "Flyball Competition Training",
    description: "Fast-paced relay race training",
    petType: "dog",
    progress: 0,
    duration: "10 weeks",
    difficulty: "Advanced",
    lessons: [{id: "flyball-intro", title: "Flyball Introduction", content: "Team racing basics", duration: "40 min", completed: false}],
  },
  {
    id: "dog-tracking",
    title: "Tracking & Trailing",
    description: "Following scent trails over distance",
    petType: "dog",
    progress: 0,
    duration: "12 weeks",
    difficulty: "Advanced",
    lessons: [{id: "tracking-start", title: "Tracking Basics", content: "Scent trail following", duration: "45 min", completed: false}],
  },
  {
    id: "dog-rally",
    title: "Rally Obedience",
    description: "Fun obedience course navigation",
    petType: "dog",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "rally-basics", title: "Rally Fundamentals", content: "Course work basics", duration: "30 min", completed: false}],
  },
  {
    id: "dog-freestyle",
    title: "Canine Freestyle Dance",
    description: "Dancing with your dog routines",
    petType: "dog",
    progress: 0,
    duration: "10 weeks",
    difficulty: "Advanced",
    lessons: [{id: "dance-moves", title: "Dance Movements", content: "Choreographed routines", duration: "35 min", completed: false}],
  },
  {
    id: "dog-barn-hunt",
    title: "Barn Hunt Training",
    description: "Hunting for rats in hay bales (safe sport)",
    petType: "dog",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "barn-intro", title: "Barn Hunt Basics", content: "Scent discrimination in hay", duration: "30 min", completed: false}],
  },
  {
    id: "dog-lure-coursing",
    title: "Lure Coursing",
    description: "Chasing mechanical lures for sighthounds",
    petType: "dog",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "lure-basics", title: "Lure Coursing Introduction", content: "Safe chase training", duration: "25 min", completed: false}],
  },
  {
    id: "dog-weight-pull",
    title: "Weight Pulling Sport",
    description: "Strength training and pulling competitions",
    petType: "dog",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Advanced",
    lessons: [{id: "pull-training", title: "Safe Weight Pulling", content: "Proper pulling technique", duration: "40 min", completed: false}],
  },
  {
    id: "dog-disc",
    title: "Disc Dog Training",
    description: "Frisbee catching and freestyle",
    petType: "dog",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "disc-catch", title: "Disc Catching Basics", content: "Frisbee fundamentals", duration: "30 min", completed: false}],
  },
  {
    id: "dog-parkour",
    title: "Urban Agility Parkour",
    description: "Using urban obstacles for fitness",
    petType: "dog",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Advanced",
    lessons: [{id: "parkour-basics", title: "Parkour Fundamentals", content: "Urban obstacle navigation", duration: "35 min", completed: false}],
  },
  {
    id: "dog-treibball",
    title: "Treibball Herding Game",
    description: "Herding giant balls into goals",
    petType: "dog",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "treibball-intro", title: "Treibball Introduction", content: "Ball herding basics", duration: "30 min", completed: false}],
  },
  {
    id: "dog-musical-freestyle",
    title: "Musical Freestyle Heeling",
    description: "Precision heeling to music",
    petType: "dog",
    progress: 0,
    duration: "10 weeks",
    difficulty: "Advanced",
    lessons: [{id: "musical-heel", title: "Musical Heeling", content: "Dancing heel patterns", duration: "40 min", completed: false}],
  },
  {
    id: "dog-nosework-advanced",
    title: "Advanced Nosework Competition",
    description: "Competition-level scent detection",
    petType: "dog",
    progress: 0,
    duration: "12 weeks",
    difficulty: "Advanced",
    lessons: [{id: "competition-scent", title: "Competition Scent Work", content: "Advanced detection", duration: "45 min", completed: false}],
  },
  {
    id: "dog-skijoring",
    title: "Skijoring Training",
    description: "Dog-powered cross-country skiing",
    petType: "dog",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Advanced",
    lessons: [{id: "ski-pull", title: "Skijoring Basics", content: "Pulling skier training", duration: "40 min", completed: false}],
  },
  {
    id: "dog-canicross",
    title: "Canicross Running",
    description: "Cross-country running with your dog",
    petType: "dog",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "run-training", title: "Canicross Fundamentals", content: "Trail running techniques", duration: "30 min", completed: false}],
  },
  {
    id: "dog-detection",
    title: "Detection Dog Training",
    description: "Professional detection work basics",
    petType: "dog",
    progress: 0,
    duration: "16 weeks",
    difficulty: "Advanced",
    lessons: [{id: "detection-intro", title: "Detection Foundations", content: "Professional scent work", duration: "50 min", completed: false}],
  },
  {
    id: "dog-avalanche",
    title: "Avalanche Rescue Training",
    description: "Specialized avalanche victim location",
    petType: "dog",
    progress: 0,
    duration: "20 weeks",
    difficulty: "Advanced",
    lessons: [{id: "avalanche-basics", title: "Avalanche Rescue Basics", content: "Snow search techniques", duration: "60 min", completed: false}],
  },
  {
    id: "dog-cadaver",
    title: "Cadaver Detection Training",
    description: "Human remains detection for professionals",
    petType: "dog",
    progress: 0,
    duration: "24 weeks",
    difficulty: "Advanced",
    lessons: [{id: "cadaver-intro", title: "Cadaver Detection Intro", content: "Specialized scent training", duration: "60 min", completed: false}],
  },
  {
    id: "dog-arson",
    title: "Arson Detection Training",
    description: "Accelerant detection for fire investigation",
    petType: "dog",
    progress: 0,
    duration: "16 weeks",
    difficulty: "Advanced",
    lessons: [{id: "arson-basics", title: "Arson Detection Basics", content: "Accelerant identification", duration: "45 min", completed: false}],
  },
  {
    id: "dog-bedbugs",
    title: "Bed Bug Detection",
    description: "Commercial pest detection work",
    petType: "dog",
    progress: 0,
    duration: "12 weeks",
    difficulty: "Advanced",
    lessons: [{id: "bedbug-detection", title: "Bed Bug Detection Training", content: "Pest scent work", duration: "40 min", completed: false}],
  },
  {
    id: "dog-truffle",
    title: "Truffle Hunting Training",
    description: "Finding valuable truffles",
    petType: "dog",
    progress: 0,
    duration: "10 weeks",
    difficulty: "Advanced",
    lessons: [{id: "truffle-search", title: "Truffle Detection", content: "Fungus finding skills", duration: "35 min", completed: false}],
  },
  {
    id: "dog-blood-tracking",
    title: "Blood Tracking Training",
    description: "Tracking wounded game for hunters",
    petType: "dog",
    progress: 0,
    duration: "12 weeks",
    difficulty: "Advanced",
    lessons: [{id: "blood-trail", title: "Blood Trail Following", content: "Hunting support work", duration: "40 min", completed: false}],
  },
  {
    id: "dog-medication-alert",
    title: "Medical Alert Training",
    description: "Detecting medical emergencies in handlers",
    petType: "dog",
    progress: 0,
    duration: "16 weeks",
    difficulty: "Advanced",
    lessons: [{id: "medical-alerts", title: "Medical Alert Training", content: "Emergency detection", duration: "50 min", completed: false}],
  },

  // Additional Cat Courses (20-50)
  {
    id: "cat-harness-walking",
    title: "Harness & Leash Training",
    description: "Safe outdoor exploration on leash",
    petType: "cat",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "harness-intro", title: "Harness Introduction", content: "Getting comfortable with harness", duration: "20 min", completed: false}],
  },
  {
    id: "cat-fetch",
    title: "Teaching Cats to Fetch",
    description: "Interactive fetch game training",
    petType: "cat",
    progress: 0,
    duration: "4 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "fetch-basics", title: "Fetch Fundamentals", content: "Retrieve training for cats", duration: "15 min", completed: false}],
  },
  {
    id: "cat-high-five",
    title: "High Five & Paw Tricks",
    description: "Fun paw-based tricks",
    petType: "cat",
    progress: 0,
    duration: "3 weeks",
    difficulty: "Beginner",
    lessons: [{id: "paw-tricks", title: "Paw Trick Training", content: "Teaching high five", duration: "12 min", completed: false}],
  },
  {
    id: "cat-spin-tricks",
    title: "Spinning & Twirling Tricks",
    description: "Teaching cats to spin on command",
    petType: "cat",
    progress: 0,
    duration: "3 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "spin-training", title: "Spin Training", content: "Circle movement tricks", duration: "15 min", completed: false}],
  },
  {
    id: "cat-jump-training",
    title: "Controlled Jump Training",
    description: "Teaching jumps through hoops",
    petType: "cat",
    progress: 0,
    duration: "5 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "hoop-jumping", title: "Hoop Jumping", content: "Jump through hoops", duration: "18 min", completed: false}],
  },
  {
    id: "cat-stay-command",
    title: "Teaching Stay Command",
    description: "Impulse control training for cats",
    petType: "cat",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Advanced",
    lessons: [{id: "cat-stay", title: "Stay Training", content: "Impulse control practice", duration: "22 min", completed: false}],
  },
  {
    id: "cat-agility-course",
    title: "Feline Agility Training",
    description: "Obstacle course navigation",
    petType: "cat",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Advanced",
    lessons: [{id: "cat-obstacles", title: "Agility Obstacles", content: "Course navigation", duration: "25 min", completed: false}],
  },
  {
    id: "cat-target-training",
    title: "Target Stick Training",
    description: "Using target stick for movement",
    petType: "cat",
    progress: 0,
    duration: "4 weeks",
    difficulty: "Beginner",
    lessons: [{id: "target-stick", title: "Target Training", content: "Following target stick", duration: "15 min", completed: false}],
  },
  {
    id: "cat-name-response",
    title: "Name Recognition Training",
    description: "Teaching cats to respond to their name",
    petType: "cat",
    progress: 0,
    duration: "3 weeks",
    difficulty: "Beginner",
    lessons: [{id: "name-training", title: "Name Response", content: "Coming when called", duration: "12 min", completed: false}],
  },
  {
    id: "cat-door-manners",
    title: "Door Dash Prevention",
    description: "Preventing cats from darting out doors",
    petType: "cat",
    progress: 0,
    duration: "5 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "door-training", title: "Door Manners", content: "Stay away from open doors", duration: "18 min", completed: false}],
  },
  {
    id: "cat-carrier-comfort",
    title: "Carrier Comfort Training",
    description: "Making carriers a safe space",
    petType: "cat",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Beginner",
    lessons: [{id: "carrier-positive", title: "Positive Carrier Training", content: "Carrier desensitization", duration: "20 min", completed: false}],
  },
  {
    id: "cat-bathing",
    title: "Bath Time Training",
    description: "Making baths less stressful",
    petType: "cat",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Advanced",
    lessons: [{id: "bath-intro", title: "Bath Introduction", content: "Water desensitization", duration: "25 min", completed: false}],
  },
  {
    id: "cat-brushing",
    title: "Grooming Tolerance Training",
    description: "Accepting brushing and grooming",
    petType: "cat",
    progress: 0,
    duration: "4 weeks",
    difficulty: "Beginner",
    lessons: [{id: "brush-training", title: "Brushing Training", content: "Positive grooming", duration: "15 min", completed: false}],
  },
  {
    id: "cat-tooth-brushing",
    title: "Dental Care Training",
    description: "Teaching cats to accept tooth brushing",
    petType: "cat",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Advanced",
    lessons: [{id: "tooth-care", title: "Tooth Brushing", content: "Dental hygiene training", duration: "20 min", completed: false}],
  },
  {
    id: "cat-nail-trim",
    title: "Nail Trimming Training",
    description: "Calm nail trimming sessions",
    petType: "cat",
    progress: 0,
    duration: "5 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "nail-training", title: "Nail Trim Training", content: "Paw handling for nails", duration: "18 min", completed: false}],
  },
  {
    id: "cat-medication",
    title: "Medication Administration",
    description: "Giving pills and liquid medication",
    petType: "cat",
    progress: 0,
    duration: "4 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "med-training", title: "Medication Training", content: "Pill giving techniques", duration: "22 min", completed: false}],
  },
  {
    id: "cat-car-travel",
    title: "Car Travel Training",
    description: "Stress-free car rides",
    petType: "cat",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "car-rides", title: "Car Ride Training", content: "Vehicle desensitization", duration: "20 min", completed: false}],
  },
  {
    id: "cat-new-pets",
    title: "Introducing New Pets",
    description: "Safe multi-pet household integration",
    petType: "cat",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Advanced",
    lessons: [{id: "pet-intro", title: "Pet Introduction Protocol", content: "Gradual pet meetings", duration: "30 min", completed: false}],
  },
  {
    id: "cat-baby-prep",
    title: "Preparing for Baby",
    description: "Helping cats adjust to new baby",
    petType: "cat",
    progress: 0,
    duration: "10 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "baby-sounds", title: "Baby Sound Desensitization", content: "Preparing for baby arrival", duration: "25 min", completed: false}],
  },
  {
    id: "cat-moving-prep",
    title: "Moving House Training",
    description: "Helping cats transition to new home",
    petType: "cat",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "move-prep", title: "Moving Preparation", content: "Transition strategies", duration: "22 min", completed: false}],
  },
  {
    id: "cat-party-manners",
    title: "Guest & Party Manners",
    description: "Calm behavior with visitors",
    petType: "cat",
    progress: 0,
    duration: "5 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "guest-training", title: "Guest Preparation", content: "Visitor desensitization", duration: "18 min", completed: false}],
  },
  {
    id: "cat-sound-desensitization",
    title: "Sound Desensitization",
    description: "Reducing fear of loud noises",
    petType: "cat",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Intermediate",
    lessons: [{id: "sound-training", title: "Sound Exposure", content: "Noise desensitization", duration: "25 min", completed: false}],
  },
  {
    id: "cat-separation-comfort",
    title: "Separation Anxiety Relief",
    description: "Helping cats feel secure alone",
    petType: "cat",
    progress: 0,
    duration: "6 weeks",
    difficulty: "Advanced",
    lessons: [{id: "separation-training", title: "Alone Time Training", content: "Building independence", duration: "20 min", completed: false}],
  },
  {
    id: "cat-window-perch",
    title: "Window Watching Enrichment",
    description: "Safe window entertainment setup",
    petType: "cat",
    progress: 0,
    duration: "2 weeks",
    difficulty: "Beginner",
    lessons: [{id: "window-setup", title: "Window Enrichment", content: "Creating viewing stations", duration: "15 min", completed: false}],
  },
  {
    id: "cat-puzzle-feeders",
    title: "Puzzle Feeder Training",
    description: "Mental stimulation through food puzzles",
    petType: "cat",
    progress: 0,
    duration: "4 weeks",
    difficulty: "Beginner",
    lessons: [{id: "puzzle-intro", title: "Puzzle Introduction", content: "Food puzzle training", duration: "12 min", completed: false}],
  },
  {
    id: "cat-clicker-advanced",
    title: "Advanced Clicker Training",
    description: "Complex behaviors using clicker",
    petType: "cat",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Advanced",
    lessons: [{id: "advanced-clicker", title: "Advanced Clicker Techniques", content: "Complex trick training", duration: "25 min", completed: false}],
  },
  {
    id: "cat-therapy-training",
    title: "Therapy Cat Training",
    description: "Training cats for therapy visits",
    petType: "cat",
    progress: 0,
    duration: "12 weeks",
    difficulty: "Advanced",
    lessons: [{id: "therapy-basics", title: "Therapy Cat Basics", content: "Calm handling training", duration: "30 min", completed: false}],
  },
  {
    id: "cat-show-training",
    title: "Cat Show Preparation",
    description: "Preparing for cat shows and judging",
    petType: "cat",
    progress: 0,
    duration: "10 weeks",
    difficulty: "Advanced",
    lessons: [{id: "show-prep", title: "Show Training", content: "Handling for shows", duration: "28 min", completed: false}],
  },
  {
    id: "cat-tricks-compilation",
    title: "Complete Trick Training",
    description: "20+ tricks for intelligent cats",
    petType: "cat",
    progress: 0,
    duration: "16 weeks",
    difficulty: "Advanced",
    lessons: [{id: "trick-collection", title: "Trick Repertoire", content: "Multiple trick training", duration: "35 min", completed: false}],
  },
  {
    id: "cat-leash-advanced",
    title: "Advanced Leash Walking",
    description: "Confident outdoor exploration",
    petType: "cat",
    progress: 0,
    duration: "8 weeks",
    difficulty: "Advanced",
    lessons: [{id: "outdoor-confident", title: "Confident Walking", content: "Advanced leash skills", duration: "25 min", completed: false}],
  },
];
